...
extension StringExtention on String {
  ...
  bool get isImage {
    final RegExp imageRegex = RegExp(r'\.(jpg|jpeg|png|gif|bmp|webp)$', caseSensitive: false);
    return imageRegex.hasMatch(this);
  }

  bool get isVideo {
    final RegExp videoRegex = RegExp(r'\.(mp4|mov|wmv|avi|mkv|flv|webm)$', caseSensitive: false);
